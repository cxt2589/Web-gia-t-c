      ...
      <section className="bg-gradient-to-r from-primary to-primary-hover p-8 md:p-12 text-silk-paper rounded-sm shadow-lg relative overflow-hidden" id="tintuc-welcome-banner">
        ...
        <div className="max-w-2xl space-y-4 relative z-10">
          ...
          <h1 className="font-serif text-3xl md:text-4xl font-bold tracking-tight">
            Ban liên lạc họ Cao Phú Mỹ, Ninh Bình kịch kính chào con cháu nội ngoại
          </h1>
          <p className="text-sm text-silk-paper/85 leading-relaxed font-sans max-w-xl">
            Cổng thông tin chính thức kết nối những người con mang dòng họ Cao sinh quán hoặc tổ cơ trú quán tại Phú Mỹ, xã Gia Phú, huyện Gia Viễn, tỉnh Ninh Bình hướng về cội nguồn phụng sự gia tộc.
          </p>
        </div>
      </section>
      ...
      <section className="grid grid-cols-1 xl:grid-cols-12 gap-8 items-start">
        ...
        <div className="xl:col-span-5 space-y-8" id="contribution-column">
          <div className="space-y-1.5 border-b border-ink-charcoal/10 pb-4">
            ...
            <p className="text-xs text-ink-charcoal/50">Cập nhật công khai và trong suốt đóng góp gìn giữ nhà thờ dòng họ Cao Phú Mỹ.</p>
          </div>
