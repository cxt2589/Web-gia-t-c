  ...
  const handleShare = () => {
    if (navigator.share) {
      navigator.share({
        ...
        text: 'Chiêm bái Phả ký, Gia phả và Tộc ước dòng họ Cao tại Phú Mỹ, Ninh Bình.',
    ...
    >
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-6">
        ...
        <div className="space-y-1 text-center md:text-left">
          <h4 className="font-serif text-sm font-bold text-primary">Họ Cao Phú Mỹ</h4>
          <p>© 2026 Ban Liên Lạc Họ Cao Phú Mỹ, Ninh Bình. Đã đăng ký bảo hộ phả tàng cổ thư gia tộc.</p>
        </div>
        ...
        <div className="flex flex-col sm:flex-row items-center gap-6">
          <div className="flex items-center space-x-6 font-semibold">
            <button 
              onClick={() => alert('Liên hệ Ban thư ký họ Cao Phú Mỹ qua hộp thư điện tử hoặc số điện thoại trưởng ban: 098.xxx.xxxx')}
              className="hover:text-primary transition-colors cursor-pointer"
            >
              Liên hệ
            </button>
            <button 
              onClick={() => alert('Đường dẫn bản đồ vệ tinh dẫn đến Nhà thờ tổ Họ Cao Phú Mỹ tại Gia Phú, Gia Viễn, Ninh Bình đang khởi tạo.')} 
              className="hover:text-primary transition-colors cursor-pointer"
            >
              Bản đồ
            </button>
